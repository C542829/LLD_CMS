 ...
 * @returns
 */
export const bedStatusMap = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
 ...
 * @returns
 */
export const sexMap = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
  let result = '未知';
 ...
 * @returns
 */
export const isDiscountMap = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
  let result = '未知';
 ...
 * @returns
 */
export const couponTypeMap = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
 ...
 * @returns
 */
export const amountFormatter = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
...
export const timeFormatter = (row: any, column: TableColumnCtx<any>, cellValue: any, index: number) => {
  return formatDateTime(cellValue, 'HH:mm:ss') || cellValue;
};
