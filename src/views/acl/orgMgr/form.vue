<template>
  <div>
    <Form :model="formData" :rules="formRules" :disabled="disabled" @submit="handleFormSubmit" @reset="handleFormReset">
      <el-form-item label="门店名称" prop="orgName">
        <el-input v-model="formData.orgName" placeholder="请输入门店名称" />
      </el-form-item>

      <el-form-item label="门店简称" prop="orgShortName">
        <el-input v-model="formData.orgShortName" placeholder="请输入门店简称" />
      </el-form-item>

      <el-form-item label="门店编号" prop="orgCode">
        <el-input v-model="formData.orgCode" placeholder="请输入门店编号" />
      </el-form-item>

      <el-form-item label="门店性质" prop="orgProperty">
        <el-select v-model="formData.orgProperty" placeholder="请选择门店性质">
      ...
      <el-form-item label="门店类型" prop="orgType">
        <el-select v-model="formData.orgType" placeholder="请选择门店类型">
      ...
      <el-form-item label="门店电话" prop="orgNumber">
        <el-input v-model="formData.orgNumber" placeholder="请输入门店电话" />
      </el-form-item>

      <el-form-item label="门店负责人" prop="orgLeader">
        <el-input v-model="formData.orgLeader" placeholder="请输入门店负责人" />
      </el-form-item>

      <el-form-item label="负责人电话" prop="orgLeaderNum">
        <el-input v-model="formData.orgLeaderNum" placeholder="请输入负责人电话" />
      </el-form-item>

      <el-form-item label="行政区域" prop="orgArea">
        <el-cascader :options="pcaTextArr" v-model="formData.orgArea" filterable placement="left" />
      </el-form-item>

      <el-form-item label="详细地址" prop="orgAddress">
        <el-input v-model="formData.orgAddress" type="textarea" :rows="2" placeholder="请输入详细地址" />
      </el-form-item>
...
import { reqAddOrg, reqUpdateOrg } from '@/api/acl/org';
 ...
 * @param model 表单数据对象
 */
const handleFormSubmit = async (model: Types.Org) => {
  const data = { ...model };
