  ...
  <div class="main-container">
    ...
    <Card class="operation-card">
      <div class="search-container">
        ...
        <div class="search-item">
          <el-input v-model="store.totalParams.amount" style="max-width: 210px" placeholder="输入金额" clearable>
            <template #prepend>
              <el-select v-model="store.totalParams.amountType" style="width: 130px">
