<template>
  <div class="coupon-list-container">
    <el-table :data="coupons" :border="true" stripe class="table-container">
      <el-table-column prop="couponDefInfo.couponName" label="资产编号" />
      <el-table-column prop="couponDefInfo.content" label="余额" />
      <el-table-column prop="fromType" label="资产类型">
        <template #default="scope">
          <el-tag effect="light">充值</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="getTime" label="折扣基础" />
      <el-table-column prop="limitTime" label="折扣率" />
      <el-table-column prop="limitTime" label="跨店消费" />
    </el-table>
    <div>
...
coupons.value = new Array(50).fill({
  id: 2445739,
  orgId: 1459,
  couponId: 7179,
