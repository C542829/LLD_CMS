      ...
      >
        ...
        <el-table-column label="操作" min-width="100">
          <template #default="{ row }">
            ...
            <el-button link type="success" @click="showDrawer(3, row)">赠送优惠券</el-button>
            <el-button link type="warning" @click="showDialog(4, row)">取消优惠券</el-button>
            <el-button link type="success" @click="showDrawer(5, row)">赠送卡金</el-button>
            <el-button link type="info" @click="showDialog(6, row)">更多</el-button>
          </template>
        </el-table-column>
      </PaginationTable>
    </Card>
